<template>
  <div class="p-6 bg-gray-100 min-h-screen">
    ...
    <div class="mb-6 space-x-4">
      <button @click="goToPrincipal" class="px-4 py-2 bg-blue-700 text-white rounded hover:bg-blue-500">
        Ir a /principal
      </button>
      <button @click="openModal" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-400">
        Crear nuevo mensaje
      </button>
    </div>
    ...
    <div v-if="messages.length">
      <div
        ...
        :key="index"
        class="bg-white shadow-md p-4 rounded mb-4 border border-gray-300"
      >
    ...
    <div v-else class="text-gray-500">No hay mensajes enviados aún.</div>
